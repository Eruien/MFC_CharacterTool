...
int CMainFrame::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
	...
	m_wndHierarchyPane.CreateEx(
		NULL, L"BoneHierarchy", this, CRect(0, 0, 100, 100),
		TRUE, 4567, dwStyle);
	m_wndHierarchyPane.EnableDocking(CBRS_ALIGN_ANY);
	DockPane(&m_wndHierarchyPane);

	m_wndExportPane.CreateEx(
		NULL, L"Exporter", this, CRect(0, 0, 100, 100),
		TRUE, 8901, dwStyle);
	m_wndExportPane.EnableDocking(CBRS_ALIGN_ANY);
	DockPane(&m_wndExportPane);
